...
/**
 * Fix a single specific check item
 */
export async function fixSingleIssue({ fields, checkId, clientContextText }) {
  return fixSeoIssues({ fields, failedItemIds: [checkId], clientContextText });
}
